                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script YUTA hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://83331098775900" }),
    Setting = Window:AddTab({ Title = "Setting", Icon = "rbxassetid://112598107670848" }),
    Stats = Window:AddTab({ Title = "Stats", Icon = "rbxassetid://135901093538341" }),
    Player = Window:AddTab({ Title = "Player", Icon = "rbxassetid://89851119131925" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "rbxassetid://94848331359915" }),
    Fruit = Window:AddTab({ Title = "Fruit", Icon = "rbxassetid://117764218168494" }),
    Raid = Window:AddTab({ Title = "Raid", Icon = "rbxassetid://107827614919642" }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "rbxassetid://114222703476457" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "rbxassetid://81123761798890" }),
	Misc = Window:AddTab({ Title = "Misc", Icon = "rbxassetid://127635310268339" }),
}
...
OrionLib:MakeNotification(
        {
            ...
            Image = "rbxassetid://74110404141390",
            Time = 7
        }
    )
_G.lakala = true

setclipboard("YUTA hub Is The Best")
	...
	if (getgenv().ED_AntiKick.CheckCaller and not checkcaller() or true) and stringlower(getnamecallmethod()) == "kick" and ED_AntiKick.Enabled then
		if getgenv().ED_AntiKick.SendNotifications then
			StarterGui:SetCore("SendNotification", {
				...
				Icon = "rbxassetid://74110404141390",
				Duration = 2,
			})
		end
...
ImageButton.Image = "http://www.roblox.com/asset/?id=74110404141390"
...
Fluent:Notify({
    Title = "YUTA hub",
    Content = "Thanks For Using YUTA hub",
    Duration = 8
})
